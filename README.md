...
To run the development environment locally, ensure Docker Desktop installed and running.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/arjunsarkar5478-rgb/FirstTake-App.git
